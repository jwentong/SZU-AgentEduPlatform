...
interface CanvasState {
  ...
  revealedElementIdList: string[]; // Elements revealed by the playback timeline
  ...
  setRevealedElementIdList: (ids: string[]) => void;
...
const useCanvasStoreBase = create<CanvasState>((set, get) => ({
  ...
  setRevealedElementIdList: (ids) => set({ revealedElementIdList: ids }),
  revealElement: (id) =>
    set((state) => ({
      hiddenElementIdList: state.hiddenElementIdList.filter((elementId) => elementId !== id),
      revealedElementIdList: state.revealedElementIdList.includes(id)
        ? state.revealedElementIdList
        : [...state.revealedElementIdList, id],
    })),
