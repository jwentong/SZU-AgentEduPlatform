  ...
  persist(
    (set, get) => {
      ...
      return {
        ...
        // This deployment has a server-managed Qwen TTS provider configured.
        // Keep voice playback available on a fresh browser origin/port; users
        // can still disable it from Audio settings when needed.
        ttsEnabled: true,
        asrEnabled: true,
