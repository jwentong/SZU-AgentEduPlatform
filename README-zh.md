...
> [!IMPORTANT]
> 本地 AI 教育平台扩展统一运行在 `http://localhost:3100`。教师端通过首页导入 PPTX/PDF，并选择“高保真还原”或“AI 增强”路径。代码边界、关键数据链路和文件放置规范见 [PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md)。旧的独立 `/teacher-agent` 实验工作流不再维护。
