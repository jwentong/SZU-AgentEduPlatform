...
import { sanitizeEnhancedGeneratedContent } from '@/lib/learning-skills/enhanced-courseware-quality';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const generatedContent = await generateSceneContent(effectiveOutline, aiCall, {
      assignedImages,
      imageMapping,
    ...
    const content = generatedContent
      ? sanitizeEnhancedGeneratedContent(effectiveOutline, generatedContent)
      : generatedContent;
