...
/** Reveal — animate a hidden slide element into view at this timeline position. */
export interface RevealAction extends ActionBase {
  type: 'reveal';
  elementId: string;
  effect?: 'fade-up' | 'fade' | 'scale';
  duration?: number;
}
...
export const SLIDE_ONLY_ACTIONS: ActionType[] = ['spotlight', 'laser', 'reveal'];
