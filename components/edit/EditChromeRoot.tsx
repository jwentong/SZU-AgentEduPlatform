...
interface EditChromeRootProps {
  ...
  readonly hideAgentPanel?: boolean;
}
 ...
 */
export function EditChromeRoot({ scene, isEditable, onToggleEditMode, hideAgentPanel = false }: EditChromeRootProps) {
  ...
  return (
    <EditShell
      ...
      rightRail={hideAgentPanel ? undefined : (
        <RightRailTabs
