...
export function useViewportSize(
  ...
  const storedViewportRatio = useCanvasStore.use.viewportRatio();
  const storedViewportSize = useCanvasStore.use.viewportSize();
  const viewportRatio = overrides.viewportRatio ?? storedViewportRatio;
  const viewportSize = overrides.viewportSize ?? storedViewportSize;
